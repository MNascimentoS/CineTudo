...
public class UpdateDeleteFilmeController implements Initializable{
    ...
    @FXML
    private JFXTextField tf_buscaPromocao;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tf_buscaPromocao.focusedProperty().addListener((ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) -> {
            if (!newValue) {
                filmeGeral = new FilmeDAO().buscaFilme(tf_buscaPromocao.getText());
