...
-- Schema cinetudo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `cinetudo` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `cinetudo` ;
...
CREATE TABLE `assento` (
  ...
  KEY `fk_assento_sessao_idx` (`sessao_id`),
  CONSTRAINT `fk_assento_sessao` FOREIGN KEY (`sessao_id`) REFERENCES `sessao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `funcionario` VALUES (1,'Mateus Nascimento','111111111','mateus.nnascimento.s@gmail.com',1,'mateus','minhasenha',1),(2,'Gerente 1','111111111','gerente1@gmail.com',1,'user','pass',1),(3,'Wellington','123456987170','well@email.com',1,'well','123',1),(4,'diogo','12313','diogo.capoarte@hotmail.com',0,'diogo','123',1),(5,'Funcionario','111.111.111-11','func1@gmail.com',0,'func1','func',1);
...
INSERT INTO `genero` VALUES (1,'Ação'),(2,'Aventura'),(3,'Comédia'),(4,'Ficção Científica'),(5,'Romance'),(6,'Suspence'),(7,'Terror'),(8,'Animação'),(9,'Infantil'),(10,'Fantasia');
...
CREATE TABLE `sala` (
  ...
  `preco_ingresso` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `sessao` (
  ...
  KEY `fk_sessao_sala_id_idx` (`sala_id`),
  ...
  CONSTRAINT `fk_sessao_sala_id` FOREIGN KEY (`sala_id`) REFERENCES `sala` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `venda` (
  ...
  `cinema_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_venda_horario1_idx` (`horario`),
...
-- Dump completed on 2016-11-03 21:43:04
